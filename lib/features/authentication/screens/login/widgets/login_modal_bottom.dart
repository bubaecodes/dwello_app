import 'package:dwello_app/features/authentication/screens/login/widgets/login_form.dart';
...
class LoginModalBottom extends StatelessWidget {
  const LoginModalBottom({super.key});
        ...
        children: [
          ...
          Text(
            ...
            style: (Theme.of(context).textTheme.headlineLarge ?? const TextStyle())
                .copyWith(color: isDark ? AppColors.homeLightGrey : AppColors.blueBg, fontSize: 25.sp, fontWeight: FontWeight.w600),
            textAlign: TextAlign.center,
          ),
          SizedBox(height: 2.h,),
          Text(
            'Sign in to continue your journey to your dream home.',
            style: (Theme.of(context).textTheme.headlineLarge ?? const TextStyle())
